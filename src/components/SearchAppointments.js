        ...
        <div className="col-md-6">
          <div className="input-group">
            ...
            <div className="input-group-append">
              <button
                type="button"
                className="btn btn-primary1 dropdown-toggle"
              ...
              <div className="sort-menu dropdown-menu dropdown-menu-right">
                <button
                  className={
                    ...
                    (this.props.orderBy === 'kidName' ? 'active' : '')
                  }
                  onClick={e =>
                    this.props.changeOrder('kidName', this.props.orderDir)
                  }
                  href="#"
                >
                  Child's Name
                ...
                <button
                  className={
                    'sort-by dropdown-item ' +
                    (this.props.orderBy === 'parentName' ? 'active' : '')
                  }
                  onClick={e =>
                    this.props.changeOrder('parentName', this.props.orderDir)
                  }
                  href="#"
                >
                  Parent's Name
